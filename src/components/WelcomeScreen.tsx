      ...
      <div className="max-w-4xl w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your free, private AI assistant that runs entirely in your browser.
            No data leaves your device, no subscriptions required.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 bg-muted/50 rounded-lg">
          ...
          <p className="text-muted-foreground">
            Click "New Chat" in the sidebar or start typing below to begin your
            first conversation. The AI model will load automatically when you
