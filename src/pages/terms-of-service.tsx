    ...
    <>
      ...
      <div className="container mx-auto max-w-4xl py-12 px-4">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Welcome to <strong>brokebot</strong> - your free, privacy-first AI
            assistant! These terms of service outline the rules and regulations
            for the use of our application and explain exactly how your data is
            handled.
          </p>
          <p>
          ...
          <p>
            ...
            these terms and provisions. If you do not agree to these terms,
          ...
          <p>
            <strong>
              brokebot is designed with privacy as the core principle.
            </strong>{" "}
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              <strong>Local AI Models:</strong> When using WebLLM models, all
              processing happens directly in your browser with no data
              transmission.
            </li>
            <li>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              ...
              OpenRouter may use your prompts to improve their models
            </li>
            <li>
              <strong>Transparency:</strong> This is clearly indicated in the
              model selection interface
            </li>
            <li>
              <strong>Alternative:</strong> Use local WebLLM models or your own
              API keys for complete privacy
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              <strong>Local Data:</strong> Remains on your device until you
              manually delete it or clear browser data
            </li>
            <li>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              Not use the service to generate harmful, illegal, or malicious
              content
            </li>
            <li>
              Respect the terms of service of third-party AI providers when
              using their models
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              The content of your conversations and any files you upload
            </li>
            <li>
              Maintaining the security of your own API keys if you choose to use
              them
            </li>
            <li>
              Understanding the privacy implications of different model choices
            </li>
            <li>
              Backing up your local data if desired (we provide export
              functionality)
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              <strong>OpenRouter:</strong> For access to various AI models (when
              you choose to use them)
            </li>
            <li>
              <strong>WebLLM:</strong> For local AI model execution (no data
              leaves your device)
            </li>
            <li>
          ...
          <p>
            Each third-party service has its own terms of service and privacy
            policy. We encourage you to read them to understand how your data is
            handled.
          </p>
          ...
          <p>
            brokebot is open source software released under the MIT License.
            This means:
          </p>
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              The community can contribute to improvements and security
            </li>
          </ul>
          ...
          <p>
            ...
            Local functionality is available offline; online features depend on
          ...
          <p>AI models may produce inaccurate, biased, or inappropriate content. Users should:</p>
          <ul className="list-disc ml-6 mb-4">
            <li>Verify important information from AI responses</li>
            <li>Use their judgment when acting on AI-generated advice</li>
            <li>
              Understand that AI models reflect patterns in their training data
            </li>
          </ul>
          ...
          <p>
            brokebot and its developers shall not be liable for any direct,
          ...
          <p>
            We may update these terms occasionally to reflect changes in the
            application or legal requirements. When we do:
          </p>
          <ul className="list-disc ml-6 mb-4">
            <li>We'll update the "Last updated" date at the top</li>
            <li>
              Significant changes will be announced through the application
            </li>
            <li>Continued use constitutes acceptance of updated terms</li>
            <li>
              You can always access the current terms within the application
            </li>
          </ul>
          ...
          <p>
            These terms are governed by the laws of Poland. Any disputes will be
            resolved in accordance with Polish jurisdiction.
          </p>
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 p-6 rounded-lg">
            ...
            <p className="mb-3">
              <strong>brokebot is built privacy-first.</strong> Your
              conversations, files, and personal data stay on your device by
              default. Only optional features (online AI models) involve any
              data transmission, and we're completely transparent about what,
              when, and why.
            </p>
            <p>
              You have complete control over your data and can use brokebot
              entirely offline if you prefer. That's the beauty of local-first
              software!
            </p>
          </div>
        </div>
